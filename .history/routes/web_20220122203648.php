...
Route::middleware('auth')->group(function () {
    ...
    //new system 
    Route::get('/admin/release/systemcreate', [App\Http\Controllers\SystemController::class, 'create'])->name('system.create');
    Route::post('/admin/release/', [App\Http\Controllers\SystemController::class, 'store'])->name('system.store');
