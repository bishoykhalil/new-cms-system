...
Route::middleware('auth')->group(function () {
    ...
    //new TC
    Route::get('/admin/releases/tccreate', [App\Http\Controllers\TcController::class, 'create'])->name('tc.create');
    Route::post('/admin/releases/crs', [App\Http\Controllers\TcController::class, 'store'])->name('cr.store');
