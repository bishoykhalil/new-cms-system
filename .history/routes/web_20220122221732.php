...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/admin/releases', [App\Http\Controllers\SystemController::class, 'store'])->name('system.store');

    //new release
    Route::get('/admin/releases/releasecreate', [App\Http\Controllers\SystemController::class, 'create'])->name('release.create');
    Route::post('/admin/releases', [App\Http\Controllers\SystemController::class, 'store'])->name('release.store');
