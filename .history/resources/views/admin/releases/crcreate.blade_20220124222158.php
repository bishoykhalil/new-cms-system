...
<h5><div class="form-group"><label for="hasIOT"> IOT</label>  <input class="btn-group-toggle" type="checkbox" id="IOT" name="hasIOT" value="1"></div>

  <div class="form-group"><label for="hasE2E"> E2E</label>  <input class="form-control" type="checkbox" id="e2e" name="hasE2E" value="1"></div></h5>
